...
<body>
   <section class="w-100 align-center min-h-full">
                    ...
                    <div role="dialog" aria-modal="true">
                        <div class="fixed inset-0 z-10 overflow-y-auto bg-white px-6 py-6 lg:hidden">
                            ...
                            <div class="mt-6 space-y-2">
                                ...
                                <a href="#"
                                    class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Log
                                    in</a>
                            </div>
                        </div>
                    </div>
